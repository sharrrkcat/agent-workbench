...
- Intent Routing settings, including optional embedding model profile id, legacy embedding model path compatibility, and per-intent custom route examples
