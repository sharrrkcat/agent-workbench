...
- Utility LLM Model Profile support is a later task. Do not register Utility LLM as a Model Profile, Provider Profile, Agent, Capability, or slash command in Intent Routing Round 1 work.
