...
| pet | Pet | command, get_settings, update_settings, list_pets, scan_pets, validate_pet, delete_pet, import_pet | /pet | json, json, json, json, json, json, json, json | pet_enabled, default_pet_id, pet_scale, show_status_bubble, jump_on_hover, running_prefix, position, bubble_texts |
