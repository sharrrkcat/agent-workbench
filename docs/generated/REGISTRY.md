...
| image_generator | Image Generator | script | default, form, generate_from_form, status | image_generation | agent.py |  |  |
...
| image_generation | Image Generation Capability | status, list_model_profiles, validate_txt2img, txt2img, queue_status, cancel, unload |  |  | json, json, json, json, json, json, json |  |
