...
| file | File Capability | read_file, read_text, read_image, read_audio | /read-file | parts, file, image, audio | allowed_directories, max_local_text_read_size_mb, max_local_image_read_size_mb, max_local_audio_read_size_mb, allowed_text_extensions, enable_read_file_command |
