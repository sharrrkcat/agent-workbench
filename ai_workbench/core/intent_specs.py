    ...
    return (
        ...
        RouteSpec(
            ...
            examples=(
                ...
                "use the current knowledge base to answer",
                "what does the project documentation say",
                "answer based on my uploaded documents",
            ),
        ...
        RouteSpec(
            ...
            examples=(
                ...
                "when does the next game come out",
                "official release date for a game",
                "latest official news about a project",
                "current price of a product",
                "latest version of a library",
                "current exchange rate CNY USD",
            ),
            execution_mode="utility_required",
