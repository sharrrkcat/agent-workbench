    ...
    def __init__(self, path, options):
        ...
        with stage("engine_imports"):
            with stage("engine_imports.torch"):
                import torch
            with stage("engine_imports.transformers.AutoConfig"):
                from transformers import AutoConfig
            with stage("engine_imports.transformers.AutoModelForCausalLM"):
