...
function MessageGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div data-slot="message-group" className={cn('flex min-w-0 flex-col gap-1.5', className)} {...props} />
  );
}
...
function Message({
  ...
  return (
    <article
      ...
      data-align={align}
      className={cn(
        'group/message relative flex w-full min-w-0 gap-3 text-base/relaxed data-[align=end]:flex-row-reverse',
        className,
      )}
      {...props}
    />
